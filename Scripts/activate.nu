...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Cachapuz\Repositorios\newest-fiware\ge-weighing\NeWest\ge_poc\generateweighins'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Cachapuz\Repositorios\newest-fiware\ge-weighing\NeWest\ge_poc\generateweighins\Scripts\deactivate.nu'
